package com.tech.mpos.mpos.lib.util;
...
import com.tech.mpos.mpos.lib.model.TlvObject;
                ...
                for (TlvObject tlvObject : tlvObjectArrayList) {
                    ...
                    // Transaction Date; 9A, 3 Byte(s)
                        ...
                        if (simpleDateFormat != null) {
                            ...
                            if (dateFormat != null) {
                                resultValue = com.tech.mpos.mpos.lib.util.HexUtil.hexadecimalToBytes(dateFormat);
                            }
                        }
                    }
                    // - Transaction Date; 9A, 3 Byte(s)
