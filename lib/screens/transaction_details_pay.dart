...
class TransactionDetails extends StatefulWidget {
  ...
  TransactionDetails({Key? key, required this.status}) : super(key: key);
...
class _TransactionDetailsState extends State<TransactionDetails> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor:
          DashboardState.allTransaction!.transactions![0].status == "success"
              ? bagroundColor
              : Colors.red[50],
                ...
                ClipPath(
                  ...
                  child: Container(
                    ...
                    color: DashboardState
                                .allTransaction?.transactions![0].status ==
                            "success"
                        ? secondaryColor
                        : Colors.red[100],
                  ),
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        DashboardState
                            .allTransaction!.transactions![0].createdAt
                            .toString()
                            .substring(
                                0,
                                DashboardState
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        "CAD ${DashboardState.allTransaction!.transactions![0].amount?.toDouble()}",
                  ...
                  Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        widget.status == "Success"
                            ? Get.off(MerchantWallet())
                            : Get.off(PaymentSetup());
                      },
            ...
            children: [
              ...
              Center(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color:
                        widget.status == "Success" ? primaryColor : Colors.red,
                    borderRadius: BorderRadius.circular(220.0),
                  ),
                  child: Center(
                    child: Icon(
              ...
              Row(
                children: [
                  ...
                  Text(
                    DashboardState.allTransaction.transactions[0].createdAt,
                    style: TextStyle(
                        color: greyColor,
                        fontWeight: FontWeight.w600,
                        fontSize: 16),
